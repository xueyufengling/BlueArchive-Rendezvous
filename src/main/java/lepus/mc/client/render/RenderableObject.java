...
public class RenderableObject implements Renderable {
	...
	public RenderableObject(VertexBuffer.Usage strategy, VertexFormat.Mode primitive, VertexFormat vertex_attributes, ResourceLocation texture) {
	...
	public RenderableObject(VertexFormat.Mode primitive, VertexFormat vertex_attributes, ResourceLocation texture) {
		this(VertexBuffer.Usage.STATIC, primitive, vertex_attributes, texture);
	}

	public RenderableObject(VertexFormat vertex_attributes, ResourceLocation texture) {
	...
	public RenderableObject(VertexBuffer.Usage strategy, VertexFormat.Mode primitive, VertexFormat vertex_attributes) {
		this(strategy, primitive, vertex_attributes, (ResourceLocation) null);
	}

	public RenderableObject(VertexFormat.Mode primitive, VertexFormat vertex_attributes) {
		this(VertexBuffer.Usage.STATIC, primitive, vertex_attributes);
	}

	public RenderableObject(VertexFormat.Mode primitive) {
	...
	public RenderableObject(VertexBuffer.Usage strategy, VertexFormat.Mode primitive, VertexFormat vertex_attributes, String texture) {
		this(strategy, primitive, vertex_attributes, ResourceLocations.build(texture));
	}

	public RenderableObject(VertexFormat.Mode primitive, VertexFormat vertex_attributes, String texture) {
		this(VertexBuffer.Usage.STATIC, primitive, vertex_attributes, texture);
	}
	...
	static interface RenderFunc {
		...
		public static RenderFunc POSITION_COLOR = (RenderableObject obj, Matrix4f frustumMatrix, Matrix4f projectionMatrix) -> {
			obj.vertices.bind();
	 ...
	 * @return
	 */
	public RenderableObject setVertexAttributes(VertexFormat vertex_attributes) {
	 ...
	 * @return
	 */
	public RenderableObject loadBuffer() {
	...
	public RenderableObject addVertex(float x, float y, float z, float r, float g, float b, float a) {
	 ...
	 * @return
	 */
	public RenderableObject flushBuffer() {
		this.invalidateData();
		this.bufferData();
	...
	public static class Instance {
		...
		Instance(RenderableObject object, Matrix4f transform, ColorRGBA shader_uniform_color, boolean visible) {
			this.object = object;
		...
		Instance(RenderableObject object, Matrix4f transform, boolean visible) {
			this(object, transform, ColorRGBA.WHITE, visible);
		}

		Instance(RenderableObject object, ColorRGBA shader_uniform_color, boolean visible) {
			this(object, new Matrix4f(), shader_uniform_color, visible);
		}

		Instance(RenderableObject object, boolean visible) {
