...
public class CloudColor {
	...
	public static final void setLevelCloudColorResolver(String levelKey, ColorLinearInterpolation skyColor, Vec3LinearInterpolation weight) {
	...
	public static final void setBiomeCloudColorResolver(String levelKey, ColorLinearInterpolation skyColor, Vec3LinearInterpolation weight) {
