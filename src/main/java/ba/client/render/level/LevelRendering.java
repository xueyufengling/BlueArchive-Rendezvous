...
import fw.client.render.gl.shader.HSLPostprocessShader;
import fw.client.render.gl.shader.ScreenShader;
import fw.client.render.gl.shader.Shader;
...
public class LevelRendering {
	...
	private static void initHalos() {
		ExecuteIn.Client(() -> {
			...
			SceneGraphNode missile = Sky.render("missile", RenderableObjects.gradualColorDroplet(0.01f, 0.3f, 10, ColorRGBA.WHITE, ColorRGBA.ORANGE));
